...
$data=array();
	...
	if($res->num_rows > 0){ 		//ya existe un usuario														
		...
		$sql= "INSERT INTO medico (usuario,contrasena,nombre,apellido,area,telefono) VALUES ('".$_REQUEST['usum']."','".$_REQUEST['passm']."','".$_REQUEST['nom']."','".$_REQUEST['ape']."','".$_REQUEST['aream']."','".$_REQUEST['teleMed']."')";    //'".$_REQUEST['DNI']."',
